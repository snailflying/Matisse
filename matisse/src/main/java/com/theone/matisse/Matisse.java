...
public final class Matisse {
     ...
     * @return User selected media' {@link com.theone.matisse.internal.entity.ResultMedia} list.
     */
    public static List<ResultMedia> obtainResult(Intent data) {
        return data.getParcelableArrayListExtra(MatisseActivity.EXTRA_RESULT_MEDIA);
    }
